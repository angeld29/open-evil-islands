...
{
    inline memory_file_ptr_t ce_res_ball_extract_mem_file(ce_res_file* res_file, size_t index)
    {
        return make_memory_file(ce_res_file_node_data(res_file, index), ce_res_file_node_size(res_file, index));
    }

    inline memory_file_ptr_t ce_res_ball_extract_mem_file_by_name(ce_res_file* res_file, const char* name)
    {
    ...
    inline ce_res_file* ce_res_ball_extract_res_file_by_name(ce_res_file* res_file, const char* name)
    {
