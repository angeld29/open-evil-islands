...
namespace cursedearth
{
    ...
    extern bool ce_bink_header_read(ce_bink_header* bink_header, memory_file_t* mem_file);
    ...
    extern bool ce_bink_audio_track_read(ce_bink_audio_track* bink_audio_track, memory_file_t* mem_file);
    extern bool ce_bink_audio_track_skip(size_t n, memory_file_t* mem_file);
    ...
    extern bool ce_bink_index_read(ce_bink_index* bink_indices, size_t n, memory_file_t* mem_file);
