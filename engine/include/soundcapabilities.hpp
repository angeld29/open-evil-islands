...
namespace cursedearth
{
    enum sound_capabilities_t {
        ...
        SOUND_CAPABILITY_SAMPLES_IN_BLOCK = 1764,
        SOUND_CAPABILITY_BLOCK_SIZE = SOUND_CAPABILITY_SAMPLE_SIZE * SOUND_CAPABILITY_SAMPLES_IN_BLOCK,
        SOUND_CAPABILITY_BLOCK_COUNT = 10
    };
}
