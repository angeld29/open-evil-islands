...
static int ce_data_file_close(memory_file_t* mem_file)
{
...
static size_t ce_data_file_read(memory_file_t* mem_file, void* ptr, size_t size, size_t n)
{
    ce_data_file* data_file = (ce_data_file*)mem_file->impl;
...
static int ce_data_file_seek(memory_file_t* mem_file, long int offset, int whence)
{
    ce_data_file* data_file = (ce_data_file*)mem_file->impl;
...
static long int ce_data_file_tell(memory_file_t* mem_file)
{
    ce_data_file* data_file = (ce_data_file*)mem_file->impl;
    return data_file->pos;
}

static int ce_data_file_eof(memory_file_t* mem_file)
{
    ce_data_file* data_file = (ce_data_file*)mem_file->impl;
    return data_file->pos == data_file->size;
}

static int ce_data_file_error(memory_file_t*)
{
    // always successful
    return 0;
}

memory_file_t* ce_mem_file_new_data(void* data, size_t size)
{
    memory_file_t* mem_file = ce_mem_file_new((ce_mem_file_vtable)
...
static int ce_bstd_file_close(memory_file_t* mem_file)
{
...
static size_t ce_bstd_file_read(memory_file_t* mem_file, void* ptr, size_t size, size_t n)
{
    ce_bstd_file* bstd_file = (ce_bstd_file*)mem_file->impl;
...
static int ce_bstd_file_seek(memory_file_t* mem_file, long int offset, int whence)
{
    ce_bstd_file* bstd_file = (ce_bstd_file*)mem_file->impl;
...
static long int ce_bstd_file_tell(memory_file_t* mem_file)
{
    ce_bstd_file* bstd_file = (ce_bstd_file*)mem_file->impl;
    return ftell(bstd_file->file);
}

static int ce_bstd_file_eof(memory_file_t* mem_file)
{
    ce_bstd_file* bstd_file = (ce_bstd_file*)mem_file->impl;
    return feof(bstd_file->file);
}

static int ce_bstd_file_error(memory_file_t* mem_file)
{
    ce_bstd_file* bstd_file = (ce_bstd_file*)mem_file->impl;
    return ferror(bstd_file->file);
}

memory_file_t* ce_mem_file_new_path(const char* path)
{
