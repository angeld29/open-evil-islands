...
{
    float ce_figfile_value_fig1(const float* params, size_t /*stride*/, const ce_complection*)
    {
        return *params;
    }

    float ce_figfile_value_fig8(const float* params, size_t stride, const ce_complection* complection)
    {
    ...
    const ce_figfile_value_tuple ce_figfile_value_tuples[] = {
        { 0x31474946, 1, ce_figfile_value_fig1 },
        { 0x38474946, 8, ce_figfile_value_fig8 }
    };

    const ce_figfile_value_tuple* ce_figfile_value_tuple_choose(uint32_t type)
    {
    ...
    ce_figfile* ce_figfile_open(ce_res_file* res_file, const char* name)
    {
        ...
        ce_figfile* figfile = (ce_figfile*)ce_alloc(sizeof(ce_figfile));
