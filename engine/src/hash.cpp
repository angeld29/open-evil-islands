...
{
    ce_hash_entry* ce_hash_entry_new(ce_hash_key hash_key)
    {
        ce_hash_entry* hash_entry = (ce_hash_entry*)ce_alloc_zero(sizeof(ce_hash_entry));
        hash_entry->hash_key = hash_key;
        return hash_entry;
    }

    void ce_hash_entry_del(ce_hash_entry* hash_entry, void (*item_dtor)(void*))
    {
        if (NULL != hash_entry) {
            if (NULL != item_dtor) {
    ...
    void ce_hash_entry_del_cascade(ce_hash_entry* hash_entry, void (*item_dtor)(void*))
    {
        if (NULL != hash_entry) {
    ...
    void ce_hash_entry_for_each(ce_hash_entry* hash_entry, void (*func)(void*))
    {
        if (NULL != hash_entry) {
    ...
    void ce_hash_entry_for_each_arg1(ce_hash_entry* hash_entry, void (*func)(void*, void*), void* arg)
    {
        if (NULL != hash_entry) {
    ...
    void ce_hash_entry_for_each_key(ce_hash_entry* hash_entry, void (*func)(ce_hash_key))
    {
        if (NULL != hash_entry) {
