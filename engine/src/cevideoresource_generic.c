...
typedef enum {
	...
	CE_BINK_SRC_PATTERN,         // 8-bit values for 2-colour pattern fill
	CE_BINK_SRC_X_OFF,           // X components of motion value
	CE_BINK_SRC_Y_OFF,           // Y components of motion value
	CE_BINK_SRC_INTRA_DC,        // DC values for intrablocks with DCT
...
typedef enum {
	...
	CE_BINK_BLOCK_RUN,      // block is composed from runs of colours with custom scan order
	CE_BINK_BLOCK_RESIDUE,  // motion block with some difference added
	CE_BINK_BLOCK_INTRA,    // intra DCT block
	CE_BINK_BLOCK_FILL,     // block is filled with single colour
...
static const uint8_t ce_bink_tree_bits[16][16] = {
...
static const uint8_t ce_bink_tree_lens[16][16] = {
...
static const uint8_t ce_bink_patterns[16][64] = {
    {
