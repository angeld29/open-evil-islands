...
{
    void ce_bbox_compute_corners(const ce_bbox* bbox, ce_vec3 corners[8])
    {
    ...
    void ce_bbox_find_min_max(const ce_vec3* center, const ce_vec3* axis_x, const ce_vec3* axis_y, const ce_vec3* axis_z, ce_vec3 corners[8], ce_vec3* min, ce_vec3* max)
    {
        float dot;
