...
namespace cursedearth
{
    ...
    ce_adb_file* ce_adb_file_new(ce_mem_file* mem_file)
    {
        ...
        ce_adb_file* adb_file = (ce_adb_file*)ce_alloc_zero(sizeof(ce_adb_file));
        ...
        adb_file->records = (ce_adb_record*)ce_alloc_zero(sizeof(ce_adb_record) * record_count);
    ...
    {
        if (NULL != adb_file) {
            ce_free(adb_file->records, sizeof(ce_adb_record) * adb_file->record_count);
