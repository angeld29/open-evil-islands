...
{
    float ce_figfile_value_fig1(const float* params, size_t /*stride*/, const complection_t*)
    {
        return *params;
    }

    float ce_figfile_value_fig8(const float* params, size_t stride, const complection_t* complection)
    {
