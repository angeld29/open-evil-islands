...
namespace cursedearth
{
    ce_cam_file* ce_cam_file_new(ce_mem_file* mem_file)
    {
        ...
        ce_cam_file* cam_file = (ce_cam_file*)ce_alloc_zero(sizeof(ce_cam_file));
        cam_file->record_count = record_count;
        cam_file->records = (ce_cam_record*)ce_alloc_zero(sizeof(ce_cam_record) * record_count);
    ...
    {
        if (NULL != cam_file) {
            ce_free(cam_file->records, sizeof(ce_cam_record) * cam_file->record_count);
